          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="#">Journal Referred</a></li>
...
<div class="container  bg-light py-5 my-5">
  <div  class="container rounded text-dark text-center content mb-3 my-5"><h2>Referred</h2>
   <div class="container table-responsive my-5" id="referred">
