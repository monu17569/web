            ...
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                  ...
                  <li><a class="dropdown-item" href="./fdp.php">FDP(Faculty Development Program)</a></li>
          ...
          <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
            <ul class="navbar-nav">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                  <li><a class="dropdown-item" href="./fundedprojects.php">Funded Projects</a></li>
...
<div class="container  bg-light py-5 my-5">
  <div  class="container rounded text-dark text-center content mb-3 my-5"><h2>Subject Experience</h2>
   <div class="container table-responsive my-5" id="expertise">
       ...
       <tbody>
               <?php
                 ...
                 while($row = mysqli_fetch_assoc($result)){
                   ...
                   echo "<tr>
                         <th scope='row'>".$sno."</th>
                         <td style='color:blue;'>".$row['subj']."</td>
                         <td><div class='progress progress-striped active'>
                          <div class='progress-bar progress-bar' style='width: ". $row['perc']."%'>". $row['perc']."%</div>
                        </div></td>
                        </tr>";
                 } 
               ?>
