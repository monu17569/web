...
<div class="container  bg-light py-5 my-5">
  <div  class="container rounded text-dark text-center content mb-3 my-5"><h2>Journal Indexing in SCI</h2>
   <div class="container table-responsive my-5" id="indexingatsci">
