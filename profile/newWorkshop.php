...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM workshop WHERE organization='$organization'");
  if(mysqli_num_rows($dup)>0)
  {
    $duplicate =true;
  }else{
    //Sql query to be executed
    $sql = "INSERT INTO workshop  (organization, topic, startDate, endDate) VALUES ('$organization','$topic','$startDate','$endDate')";
...
<body>
      <!-- Nav bar starts -->
      <a href="./workshop.php" style="text-decoration: none;">
        <div class="alert alert-primary my-2" role="alert">
          <h2>Edit Your Worskshop </h2>
        </div>
      </a>
      <!-- Nav bar ends -->
    ...
    <div class="container my-4">
        ...
        <form action="./newWorkshop.php" method="post">
          <div class="mb-3">
