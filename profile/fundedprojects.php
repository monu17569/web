...
if(isset($_GET['delete'])){
  $id = $_GET['delete'];
  $delete = true;
  $sql = "DELETE FROM `fundedprojects` WHERE `id` = $id";
...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
  if (isset( $_POST['idEdit'])){
    // Update the record
      ...
      $fundingagency = $_POST["fundingagencyEdit"];
    ...
    // Sql query to be executed
      $sql = "UPDATE `fundedprojects` SET `title` = '$title' , `fundingagency` = '$fundingagency',`duration` = '$duration' ,`rol` = '$role' , `stat` = '$status' WHERE `fundedprojects`.`id` = $id";
      $result = mysqli_query($conn, $sql);
      if($result){
        $update = true;
      }
...
<body>
          ...
          <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <form action="./fundedprojects.php" method="post">
                  <div class="modal-body">
                    ...
                    <div class="mb-3">
                      <label for="fundingagency" > <h5>Funding Agency</h5></label>
                      <input type="text" class="form-control" id="fundingagencyEdit" name="fundingagencyEdit" required>
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control"  id="roleEdit" name="roleEdit" required >
                    </div>
     ...
     <!-- for displaying alerts -->
      <?php if($delete){
            ...
            echo "<a href='./fundedprojects.php'>";
     ...
     <a href="./newFundedprojects.php"><button type="button" class="btn btn-warning"><h4>Add New</h4></button></a>
     </div>

   <div class="container my-5" id="fundedprojects" >
  ...
  <script>
   ...
   Array.from(edits).forEach((element) =>{
     element.addEventListener("click",(e) =>{
       ...
       fundingagency = tr.getElementsByTagName("td")[1].innerText;
       duration = tr.getElementsByTagName("td")[2].innerText;
       role = tr.getElementsByTagName("td")[3].innerText;
       status = tr.getElementsByTagName("td")[4].innerText;
       console.log(title, fundingagency, duration, role,status);
       titleEdit.value = title;
       fundingagencyEdit.value = fundingagency;
    ...
    Array.from(deletes).forEach((element) => {
      element.addEventListener("click", (e) => {
        ...
        if (confirm("Are you sure you want to delete !")) {
          console.log("yes");
          window.location = `./fundedprojects.php?delete=${id}`;
        }
        else {
          console.log("no");
        }
