...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM fdp WHERE topic='$topic'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO fdp (topic , duration, organization) VALUES ('$topic','$duration', '$organization')";
...
<body>
      ...
      <div class="alert alert-primary my-2" role="alert">
          <h2><a href="./fdp.php"><button type="button" 
    ...
    <div class="container my-4">
        ...
        <form action="./newFdp.php" method="post">
          <div class="mb-3">
