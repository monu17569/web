...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM referred WHERE Disc='$description'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO referred (Disc,years) VALUES ('$description',$year)";
...
<body>
      ...
      <div class="alert alert-primary my-2" role="alert">
          <h2><a href="./referred.php"><button type="button" 
                class="btn btn-outline-dark" ><strong>Back</strong></button></a>
                Edit Your Referred Data
          </h2>
        </div>
      <!-- Nav bar ends -->
    ...
    <div class="container my-4">
        ...
        <form action="./newReferred.php" method="post">
          <div class="mb-3">
