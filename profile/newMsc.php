...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM msc WHERE names='$name'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO msc (names, rollno, title, duration, category) VALUES ('$name','$rollno','$title','$duration','$category')";
...
<body>
      <!-- Nav bar starts -->
        <div class="alert alert-primary my-2" role="alert">
          <h2><a href="./msc.php"><button type="button" 
                class="btn btn-outline-dark" ><strong>Back</strong></button></a>
                Edit Your MSC Major/Minor Projects
          </h2>
        </div>
      <!-- Nav bar ends -->
    ...
    <div class="container my-4">
        ...
        <form action="./newMsc.php" method="post">
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="rollno" class="form-label"> <h5>Roll No.</h5></label>
