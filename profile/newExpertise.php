...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM subjectexpertise WHERE subj='$subject'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO subjectexpertise (subj , perc) VALUES ('$subject','$percentage')";
...
<body>
      <!-- Nav bar starts -->
      <a href="./expertise.php" style="text-decoration: none;">
        <div class="alert alert-primary my-2" role="alert">
          <h2>Edit Your Subject Expertise </h2>
        </div>
      </a>
      <!-- Nav bar ends -->
    ...
    <div class="container my-4">
        ...
        <form action="./newExpertise.php" method="post">
          ...
          <div class="mb-3">
            <label for="percentage" class="form-label"> <h5>Percentage</h5></label>
