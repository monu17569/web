...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM phd WHERE names='$name'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO phd (names, title, stat) VALUES ('$name','$title','$status')";
...
<body>
      <!-- Nav bar starts -->
        <div class="alert alert-primary my-2" role="alert">
          <h2><a href="./phd.php"><button type="button" 
    ...
    <div class="container my-4">
        ...
        <form action="./newPhd.php" method="post">
          <div class="mb-3">
