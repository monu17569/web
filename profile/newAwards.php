...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM awards WHERE awardName='$awardName'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO awards (awardName , Disc) VALUES ('$awardName','$description')";
...
<body>
    ...
    <div class="container my-4">
        ...
        <form action="./newAwards.php" method="post">
          <div class="mb-3">
            <label for="awardName" class="form-label"> <h5>Award Name</h5></label>
            <input type="text" class="form-control" id="awardName" name="awardName" required >
          </div>
