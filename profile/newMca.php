...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $dup = mysqli_query($conn,"SELECT * FROM mca WHERE names='$name'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO mca (names, rollno, title, duration) VALUES ('$name','$rollno','$title','$duration')";
...
<body>
      <!-- Nav bar starts -->
        <div class="alert alert-primary my-2" role="alert">
          <h2><a href="./mca.php"><button type="button" 
                class="btn btn-outline-dark" ><strong>Back</strong></button></a>
                Edit Your MCA Major Projects
          </h2>
        </div>
      <!-- Nav bar ends -->
    ...
    <div class="container my-4">
        ...
        <form action="./newMca.php" method="post">
          <div class="mb-3">
