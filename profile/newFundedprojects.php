...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $fundingagency = $_POST["fundingagencyname"];
  $duration = $_POST["durationname"];
  $role = $_POST["rolename"];
  $status = $_POST["statusname"];

    //  duplicate value check
  $dup = mysqli_query($conn,"SELECT * FROM fundedprojects WHERE title='$title'");
  if(mysqli_num_rows($dup)>0)
  {
    ...
    $sql = "INSERT INTO fundedprojects (title, fundingagency, duration, rol, stat) VALUES ('$title','$fundingagency','$duration','$role','$status')";
...
<body>
      <!-- Nav bar starts -->
        <div class="alert alert-primary my-2" role="alert">
          <h2><a href="./fundedprojects.php"><button type="button" 
                class="btn btn-outline-dark" ><strong>Back</strong></button></a>
                Edit Your Funded Projects
          </h2>
        </div>
      <!-- Nav bar ends -->
     ...
     <?php 
      if($insert){
        ...
        echo "<a href='./newFundedprojects.php'>";
    ...
    <div class="container my-4">
        ...
        <form action="./newFundedprojects.php" method="post">
          <div class="mb-3">
          ...
          <div class="mb-3">
            <label for="fundingagency" class="form-label"> <h5>Funding Agency</h5></label>
            <input type="text" class="form-control" id="fundingagencyname" name="fundingagencyname" required>
          </div>

          <div class="mb-3">
            <label for="duration" class="form-label"><h5>Duration</h5></label>
            <input type="text" class="form-control"  id="durationname" name="durationname" required >
          </div>
